...
<style>
    ...
    .vue-vertical-item.no-touch {
        -ms-touch-action: none;
        touch-action: none;
    }

    .vue-vertical-item.cssTransforms {
        transition-property: transform;
        left: 0;
        right: auto;
    }

    .vue-vertical-item.cssTransforms.render-rtl {
        left: auto;
        right: 0;
    }

    .vue-vertical-item.resizing {
        opacity: 0.6;
        z-index: 3;
    }

    .vue-vertical-item.vue-draggable-dragging {
        transition:none;
        z-index: 3;
    }

    .vue-vertical-item.vue-vertical-placeholder {
        background: red;
        opacity: 0.2;
    ...
    .vue-vertical-item > .vue-resizable-handle {
        position: absolute;
        width: 20px;
        height: 20px;
        bottom: 0;
    ...
    .vue-vertical-item > .vue-rtl-resizable-handle {
        bottom: 0;
        left: 0;
    ...
    .vue-vertical-item.disable-userselect {
        user-select: none;
    }
</style>
<script>
